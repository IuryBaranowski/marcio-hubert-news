...
interface EventCardProps {
  ...
  imageAlt: string;
  category: string;
  categoryColor: "green" | "blue" | "purple" | "red";
  location: string;
  title: string;
  description: string;
  date: string;
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="p-4 md:p-6 flex flex-col justify-between">
          <div>
            ...
            <h3 className="font-serif font-bold text-lg md:text-2xl text-[#0A1628] mb-2 md:mb-3 leading-tight group-hover:text-[#C8102E] transition-colors">
              {title}
            </h3>
          ...
          <div className="flex items-center justify-between">
            ...
            <Link
              href={href}
              className="text-[#C8102E] font-semibold text-xs md:text-sm hover:underline"
            >
              Ver cobertura →
            </Link>
          </div>
